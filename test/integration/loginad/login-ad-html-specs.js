...
describe('Loginad-html-specs', function() {
    ...
    describe("Ad Loaded", function() {
        ...
        it('should have wallpaper image visible', function() {
            return browser
        	    ...
        	    // check correct image background
            	.getCssProperty('#html_container', 'background-image')
                .then(function(image) {
                    // console.log(image);
                    // output the following: {
                    //     property: 'backgound-image',
                    //     value: 'url("https://s.yimg.com/cv/ae/us/audience/040414/1440x1024x2k0t7oif.jpg")'
                    // }
    ...
    describe('click on video to play', function() {
		...
		// Exlude test on IE9 because IE9 in SauceLab doesn't has flash plugin installed
